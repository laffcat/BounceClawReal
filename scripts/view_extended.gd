...
var swayPos_max : float = 0.2                  # default: 0.1
var swayPos_speed : float = 4.0                 # default: 9.0
var swayRot : Vector3 = Vector3.ZERO
var swayRot_angle : float = 3.0                 # default: 5.0   (old: Vector3(5.0, 5.0, 2.0))
var swayRot_max : float = 2.0                  # default: 15.0  (old: Vector3(12.0, 12.0, 4.0))
var swayRot_speed : float = 3.0                 # default: 10.0
var idlePos_scale = 0.05                        # default: 0.1
...
var idleRot_scale = 0.1                         # default: 0.5
