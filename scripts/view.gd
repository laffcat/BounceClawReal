...
#Bob
var cl_bob : float = 0.001             # default: 0.01
var cl_bobup : float = 0.2            # default: 0.5
var cl_bobcycle : float = 0.8         # default: 0.8
var ql_bob : float = 0.0012            # default: 0.012
var ql_bobup : float = 0.2            # default: 0.5
var ql_bobcycle : float = 0.6         # default: 0.6

#Roll
var rollangles : float = 3.0          # default: 15.0
var rollspeed : float = 300.0         # default: 300.0
var tiltextra : float = 1.0           # default: 2.0
